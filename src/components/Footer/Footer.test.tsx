...
vi.mock('../../context/SettingsContext', () => ({
  useSettings: () => ({
    settings: {
      ...
      phone: '(47) 99746-4218',
      address: 'Blumenau - SC',
      email: 'mgclimatizacao401@gmail.com',
      instagram: 'https://instagram.com/mgclimabnu',
      facebook: '',
    },
  }),
}));
...
describe('fechamento público da landing page', () => {
  ...
  it('usa logo oficial, domínio correto e nomenclatura sem preço no Footer', () => {
    ...
    expect(screen.getByRole('link', { name: 'Instagram' })).toHaveAttribute('href', 'https://instagram.com/mgclimabnu');
    expect(screen.getByRole('link', { name: 'mgclimatizacao401@gmail.com' })).toHaveAttribute('href', 'mailto:mgclimatizacao401@gmail.com');
  });
